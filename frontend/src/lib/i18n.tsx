...
const translations = {
  en: {
    ...
    aiDailyLimitReached: "The AI assistant has reached its daily limit. Try again tomorrow.",
  ...
  es: {
    ...
    aiDailyLimitReached: "El asistente de IA alcanzó su límite diario. Vuelve a intentarlo mañana.",
